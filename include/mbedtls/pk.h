...
typedef int (*mbedtls_pk_rsa_alt_write_pubkey_func)(void* ctx, unsigned char** p, unsigned char* start);
 ...
 * \note            This function replaces \c mbedtls_pk_setup() for RSA-alt.
 */
int mbedtls_pk_setup_rsa_alt2(mbedtls_pk_context* ctx, void* key, mbedtls_pk_rsa_alt_decrypt_func decrypt_func,
